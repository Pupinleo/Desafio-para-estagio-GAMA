...
/**
 * REST controller for managing {@link com.enem.metaaluno.domain.Aluno}.
 */
@RestController
...
public class AlunoResource {
    ...
    public ResponseEntity<Aluno> createAluno(@Valid @RequestBody Aluno aluno) throws URISyntaxException {
        ...
        return ResponseEntity.created(new URI("/api/alunos/" + aluno.getId()))
            .headers(HeaderUtil.createEntityCreationAlert(applicationName, true, ENTITY_NAME, aluno.getId().toString()))
            .body(aluno);
    }
